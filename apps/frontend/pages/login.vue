...
<template>
  ...
  >
    ...
    >
      ...
      <div
        class="absolute -top-10 -right-10 w-40 h-40 bg-primary-100 rounded-full opacity-50 blur-2xl"
      ></div>
      <div
        class="absolute -bottom-10 -left-10 w-40 h-40 bg-primary-200 rounded-full opacity-50 blur-2xl"
      ></div>
