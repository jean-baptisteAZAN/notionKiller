<script setup lang="ts">
  ...
  function handleKeyboardShortcuts(e: KeyboardEvent) {
    for (const [name, config] of Object.entries(SHORTCUTS)) {
      if (
        ...
        emit('insert-markdown', config.prefix, config.suffix, editorState.selectedText || config.placeholder)
        break
      }
    }
  }
  ...
  function getSelection() {
    ...
    return {
      content: props.modelValue.substring(textarea.selectionStart, textarea.selectionEnd),
  ...
  function handleModalInsert(prefix: string, suffix: string, placeholder: string) {
